...
@pytest.fixture
def jinja_template():
    return "tests/fixtures/schema-based/dag_template.jinja"


@pytest.fixture
def jinja_template_hook():
    return "tests/fixtures/schema-based/hook_template.jinja"
...
@pytest.fixture
def output_file_bad():
    return "tests/output/schema-based/generated_dag-bad.py"
