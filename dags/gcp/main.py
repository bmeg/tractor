...
def trigger_dag_gcf(data, context=None):
    ...
    web_server_url = (
       "https://1a51d33b8c594318a73c0464dd87c06b-dot-us-west1.composer.googleusercontent.com"
    )
    # Replace with the ID of the DAG that you want to run.
    dag_id = 'composer_sample_trigger_response_dag'

    response = composer2_airflow_rest_api.trigger_dag(web_server_url, dag_id, data.json)
    print(response)
    return response
